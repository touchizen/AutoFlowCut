...
export function useStoryPipeline({ projectPath, onPushScenes, onPushCharacters, enabled = true }) {
  ...
  // 그대로 machine.audioPreflight(params)에 넘긴다 — projectToken 불필요, pickAudioImportFile과 동일 형태.
