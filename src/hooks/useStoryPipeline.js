...
export function useStoryPipeline({ projectPath, onPushScenes, onPushCharacters }) {
  ...
  // M2 오디오 사전점검(§4.1/§4.3): story-api.js의 핸들러는 guarded()로 감싸지 않고 params를
  // 단일 storyCommands.audioPreflight(params)에 넘긴다 — projectToken 불필요, pickAudioImportFile과 동일 형태.
