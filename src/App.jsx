...
function App() {
  ...
  // Project Data 관리
  const { addPendingSave, handleProjectChange, saveCurrentProject, saveCurrentProjectWithPayload, buildCurrentProjectData, isRestoringRef, loadEpochRef, projectLoading, hydratedRef: projectHydratedRef, flowProjectReady, flowProjectId: _flowProjectId, tryAdoptFlowProject } = useProjectData({
  ...
  const fullProjectBusy = isImageFirstImporting || anyRunning || refBatchRunning || videoRetryRunning || uiSceneBatchBlocked || thumbnailGenerating || galleryUploading
