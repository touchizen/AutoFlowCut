...
const ALLOWED = new Set([
  'video.admit', 'video.status', 'batch.status',
  // M3: 에이전트의 눈/Export. scene.snapshot=라이브 씬 배열, video.frames=프레임 추출, export.*=실행.
  'scene.snapshot', 'video.frames', 'export.capcut', 'export.premiere',
])
