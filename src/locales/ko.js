...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  toast: {
    ...
    authErrorStop: '인증 오류로 중단합니다. API 키를 확인한 후 다시 시도해주세요.',
    ...
    flowLoginRequired: 'Google API 키가 필요합니다. 설정에서 입력해주세요.',
    flowLoginExpiredTitle: 'API 키 필요',
    flowLoginExpiredMessage: '설정에서 Google API 키를 추가하거나 갱신한 뒤 다시 시도해주세요.',
