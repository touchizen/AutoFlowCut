...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  settings: {
    ...
    openaiKeyTitle: 'OpenAI API 키 (gpt-image)',
    openaiKeySet: '설정됨',
    openaiKeyNotSet: '미설정',
    openaiKeyInputLabel: 'OpenAI 키',
    openaiKeyPlaceholder: 'sk-...',
    openaiKeyVerifySave: '검증 후 저장 (OpenAI)',
    openaiKeyRemove: 'OpenAI 키 삭제',
    openaiKeyNote: 'OS 키체인에 암호화 저장. gpt-image-1 은 조직 인증(org verification)이 필요.',
    openaiKeyGetKey: 'OpenAI API 키 발급 →',
    grokKeyTitle: 'xAI API 키 (Grok 비디오)',
    grokKeySet: '설정됨',
    grokKeyNotSet: '미설정',
    grokKeyInputLabel: 'xAI 키',
    grokKeyPlaceholder: 'xai-...',
    grokKeyVerifySave: '검증 후 저장 (xAI)',
    grokKeyRemove: 'xAI 키 삭제',
    grokKeyNote: 'OS 키체인에 암호화 저장. Grok 비디오는 실키 smoke 통과 전까지 선택 UI에서 숨겨짐.',
    grokKeyGetKey: 'xAI API 키 발급 →',
    falKeyTitle: 'fal.ai API 키 (이미지·비디오)',
    falKeySet: '설정됨',
    falKeyNotSet: '미설정',
    falKeyInputLabel: 'fal.ai 키',
    falKeyPlaceholder: 'fal 키를 붙여넣으세요',
    falKeyVerifySave: 'fal.ai 키 저장',
    falKeyRemove: 'fal.ai 키 삭제',
    falKeyNote: 'OS 키체인에 암호화 저장. fal 이미지·비디오는 실키 smoke 통과 전까지 선택 UI에서 숨겨짐.',
    falKeyGetKey: 'fal.ai API 키 발급 →',
    falKeySavedUnverified: 'fal.ai 키를 저장했습니다 (미검증 — 첫 생성 시 검증됩니다)',
    wavespeedKeyTitle: 'WaveSpeed API 키 (비디오)',
    wavespeedKeySet: '설정됨',
    wavespeedKeyNotSet: '미설정',
    wavespeedKeyInputLabel: 'WaveSpeed 키',
    wavespeedKeyPlaceholder: 'WaveSpeed 키를 붙여넣으세요',
    wavespeedKeyVerifySave: '검증 후 저장 (WaveSpeed)',
    wavespeedKeyRemove: 'WaveSpeed 키 삭제',
    wavespeedKeyNote: 'OS 키체인에 암호화 저장. 정상처럼 보이는 키도 잔액 충전 전에는 비활성일 수 있음. WaveSpeed 비디오는 실키 smoke 통과 전까지 선택 UI에서 숨겨짐.',
    wavespeedKeyGetKey: 'WaveSpeed API 키 발급 →',
    higgsfieldKeyTitle: 'Higgsfield API 인증 정보 (비디오)',
    higgsfieldKeySet: '설정됨',
    higgsfieldKeyNotSet: '미설정',
    higgsfieldKeyInputLabel: 'Higgsfield 키',
    higgsfieldKeyPlaceholder: 'Higgsfield 키를 붙여넣으세요',
    higgsfieldSecretInputLabel: 'Higgsfield 시크릿',
    higgsfieldSecretPlaceholder: 'Higgsfield 시크릿을 붙여넣으세요',
    higgsfieldKeyVerifySave: '검증 후 저장 (Higgsfield)',
    higgsfieldKeyRemove: 'Higgsfield 인증 정보 삭제',
    higgsfieldKeyNote: '키와 시크릿을 key:secret로 결합해 OS 키체인에 암호화 저장. Higgsfield 비디오는 실키 smoke 통과 전까지 선택 UI에서 숨겨짐.',
    higgsfieldKeyGetKey: 'Higgsfield API 인증 정보 발급 →',
