...
export default {
  ...
  story: {
    ...
    synopsis: {
      ...
      confirmHint: '등장인물을 확정하고 이 시놉시스로 대본(시나리오) 생성을 시작합니다.',
      regenerate: '시놉시스 다시',
      backToSetup: '설정으로',
    ...
    review: {
      ...
      runHintScript: '대본을 몰입도(궁금증·기대감·추진력·명료성·보상감) 기준으로 검토·수정하고, 몰입감 점수(0~100)를 매깁니다.',
      runHint: '{target}을(를) 검토하고 필요하면 지정 횟수만큼 수정합니다.',
      autoHint: '생성 직후 {target}을(를) 자동으로 검토·수정합니다.',
      autoHintScript: '대본 생성 직후 자동으로 검토·수정하고 몰입감 점수를 매깁니다.',
      roundsHint: '검토·수정을 반복할 최대 횟수 (1~5)',
    },
    action: {
      retry: '재실행',
      ...
      continue: '이어쓰기',
      split: '분리시작',
      abortHint: '진행 중인 생성/검수를 중단합니다.',
      rewriteHint: '현재 대본을 버리고 처음부터 새로 생성합니다.',
      continueHint: '현재 대본 끝에 이어서 더 생성합니다.',
      splitHint: '대본을 화자·장면 단위의 씬으로 분리합니다.',
      setupStart: '시작',
      setupStartIcon: '✨ 시작',
      setupComplete: '완료됨',
      ...
      setupStartHint: '제목만 입력했으면 시놉시스 생성을, 대본을 붙여넣었으면 그 대본으로 진행을 시작합니다.',
      scenesRedoHint: '현재 대본으로 씬 분리를 다시 실행합니다.',
      promptsRedoHint: '각 씬의 이미지·비디오 프롬프트를 다시 생성합니다.',
      audioRedoHint: '각 씬의 오디오(내레이션·효과음)를 다시 생성합니다.',
      close: '닫기',
    },
    form: {
      genreDesc: '이야기 유형',
