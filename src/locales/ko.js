...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  import: {
    ...
    imageFirstTitle: '이미지 우선 Story 가져오기',
    imageFirstDesc: '순서가 고정된 이미지 세트를 Story 생성 전에 확정',
    imageFirstBack: '형식 목록',
    imageFirstSelectImages: 'PNG/JPEG 이미지 선택',
    imageFirstSelectStoryboard: '스토리보드 CSV 선택 (선택사항)',
    imageFirstOrderHint: '이미지 순서를 확정해. 첫 확인 뒤에는 순서를 바꿀 수 없어.',
    imageFirstConfirm: '이미지 우선 가져오기 확정',
    imageFirstImporting: '가져오는 중…',
    imageFirstImportFailed: '이미지 우선 가져오기에 실패했어.',
    imageFirstImportCancelled: '이미지 우선 가져오기를 취소했어.',
    sceneImageNotPng: '이미지를 PNG로 정규화하지 못했어.',
    sceneImageReadFailed: '이미지 파일을 읽지 못했어.',
