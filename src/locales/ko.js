...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  upscayl: {
    ...
    blockedByUpscayl: '업스케일이 진행 중이에요 — 끝난 뒤 다시 시도해 주세요',
    checking: 'Upscayl 확인 중...',
    notInstalled: 'Upscayl이 설치되어 있지 않습니다',
    noModels: 'Upscayl 모델을 찾지 못했습니다',
    installHintMac: '`brew install --cask upscayl`로 설치하거나 upscayl.org에서 다운로드하세요.',
    installHintWindows: 'upscayl.org에서 Upscayl을 다운로드해 설치하세요.',
    installHintLinux: '.deb 패키지를 설치하거나 직접 압축 해제한 AppImage 바이너리를 지정하세요.',
    openWebsite: 'upscayl.org 열기',
    locate: '직접 찾기',
    recheck: '다시 확인',
    model: '모델',
    scale: '배율',
    targetOne: '대상 {count}개',
    targetMany: '대상 {count}개',
    alreadyUpscaled: '업스케일됨 {count}개',
    skippedNoFile: '파일 없음 스킵 {count}개',
    start: '시작',
    cancel: '취소',
    current: '현재: {scene}',
    elapsed: '경과 {time}',
  ...
  exportModal: {
    ...
    renderPackage: '로컬 MP4 렌더',
    renderPackageDesc: '내보내기 횟수 차감 없이 완성된 MP4를 로컬에서 렌더합니다',
    renderMode: '렌더 품질',
    renderModePreview: '미리보기 · 720p',
    renderModeFinal: '최종 · 전체 해상도',
    renderBurnSubtitle: '영상에 자막 입히기',
    renderBurnSubtitleHint: '자막을 렌더된 MP4 영상에 직접 삽입합니다.',
    renderProgress: 'MP4 렌더링 중…',
    renderElapsed: '경과 {time}',
    renderCancel: '렌더 취소',
    renderCancelConfirm: '진행 중인 렌더를 취소할까요? 지금까지의 렌더가 폐기됩니다.',
  ...
  toast: {
    ...
    renderComplete: 'MP4 렌더 완료!',
    renderCancelled: 'MP4 렌더가 취소되었습니다.',
