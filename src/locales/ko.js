...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  toast: {
    ...
    sessionTargetUnsupported: '선택한 세션 타깃에서는 생성을 시작할 수 없습니다.',
    chatgptReferencesUnsupported: 'ChatGPT 레퍼런스 이미지 업로드는 아직 측정되지 않아 이 요청을 제출하지 않았습니다.',
    chatgptVideoUsesApi: 'ChatGPT 타깃의 비디오는 API 공급자로 라우팅되며 이 세션 뷰에서는 시작할 수 없습니다.',
    chatgptUnmeasuredOptionsIgnored: 'ChatGPT 타깃은 화면비와 시드를 제어할 수 없습니다 — 프로젝트 설정과 무관하게 정사각형 이미지로, 시드 재현 없이 생성됩니다.',
