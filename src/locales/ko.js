...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  import: {
    ...
    storyOpenFailed: '이 프로젝트의 Story를 열지 못했어.',
    textTab: '텍스트',
    csvTab: 'CSV',
    srtTab: 'SRT',
    ...
    storyboardHeaderDuplicate: '같은 storyboard field에 두 번 binding되는 CSV header가 있습니다.',
    storyboardHeaderUnknown: '지원하지 않거나 손상된 CSV header가 있습니다.',
    storyboardSceneInvalid: 'scene 값이 비어 있거나 JavaScript safe integer가 아닙니다.',
    storyboardSceneOrderInvalid: 'scene 번호가 행 순서에서 감소했습니다.',
    storyboardPromptAmbiguous: '같은 slot에 서로 다른 prompt가 여러 개 있습니다.',
    storyboardFieldAmbiguous: '같은 slot에 collapse할 수 없는 서로 다른 scene field 값이 있습니다.',
    storyboardPromptMissing: 'visual-only slot에는 영문 prompt가 필요합니다.',
    storyboardSpeakerMissing: '자막이 있는 행에 speaker가 없습니다.',
    storyboardSpeakerUnknown: 'speaker가 roster에 없거나 허용되지 않는 narrator alias입니다.',
    storyboardSpeakerAmbiguous: 'speaker가 roster의 여러 카드와 일치합니다.',
    storyboardTimeInvalid: '시간 값이 없거나 올바른 순서의 일반 십진수 시간이 아닙니다.',
    storyboardDurationMissing: 'visual-only slot에는 prompt와 유효한 duration이 필요합니다.',
    audioTitle: '오디오 패키지',
