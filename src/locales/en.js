...
export default {
  ...
  story: {
    ...
    synopsis: {
      ...
      confirmHint: 'Confirms the characters and starts generating the script from this synopsis.',
    ...
    review: {
      ...
      runHintScript: 'Reviews and revises the script for immersion (curiosity, anticipation, momentum, clarity, payoff) and rates it 0–100.',
      runHint: 'Reviews {target} and revises it up to the set number of rounds if needed.',
      autoHint: 'Automatically reviews and revises {target} right after generation.',
      autoHintScript: 'Automatically reviews, revises, and scores the script right after generation.',
      roundsHint: 'Max number of review/revise rounds (1–5)',
    },
    action: {
      retry: 'Retry',
      ...
      continue: 'Continue',
      split: 'Split scenes',
      abortHint: 'Stops the running generation/review.',
      rewriteHint: 'Discards the current script and generates a new one from scratch.',
      continueHint: 'Generates more text continuing from the end of the current script.',
      splitHint: 'Splits the script into scenes by speaker and shot.',
      setupStart: 'Start',
      ...
      setupStartHint: 'With only a title it starts synopsis generation; with a pasted script it proceeds using that script.',
      scenesRedoHint: 'Re-runs scene splitting on the current script.',
      promptsRedoHint: 'Regenerates the image/video prompts for every scene.',
      audioRedoHint: 'Regenerates the audio (narration/SFX) for every scene.',
      close: 'Close',
    },
    form: {
