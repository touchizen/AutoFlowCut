...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  settings: {
    ...
    // Consolidated API key categories
    apiKeyGenerationSectionTitle: 'Image & Video',
    apiKeyVoiceSectionTitle: 'Voice (TTS)',

    // BYOK Google API key
    apiKeyTitle: 'Google API Key (BYOK)',
    openaiKeyTitle: 'OpenAI API Key (gpt-image)',
    openaiKeySet: 'Set',
    openaiKeyNotSet: 'Not set',
    openaiKeyInputLabel: 'OpenAI key',
    openaiKeyPlaceholder: 'sk-...',
    openaiKeyVerifySave: 'Verify & Save (OpenAI)',
    openaiKeyRemove: 'Remove OpenAI key',
    openaiKeyNote: 'Stored encrypted in your OS keychain. gpt-image-1 requires a verified organization.',
    openaiKeyGetKey: 'Get an OpenAI API key →',
    grokKeyTitle: 'xAI API Key (Grok video)',
    grokKeySet: 'Set',
    grokKeyNotSet: 'Not set',
    grokKeyInputLabel: 'xAI key',
    grokKeyPlaceholder: 'xai-...',
    grokKeyVerifySave: 'Verify & Save (xAI)',
    grokKeyRemove: 'Remove xAI key',
    grokKeyNote: 'Stored encrypted in your OS keychain. Grok video remains hidden until the real-key smoke test passes.',
    grokKeyGetKey: 'Get an xAI API key →',
    falKeyTitle: 'fal.ai API Key (image & video)',
    falKeySet: 'Set',
    falKeyNotSet: 'Not set',
    falKeyInputLabel: 'fal.ai key',
    falKeyPlaceholder: 'Paste your fal key',
    falKeyVerifySave: 'Save fal.ai key',
    falKeyRemove: 'Remove fal.ai key',
    falKeyNote: 'Stored encrypted in your OS keychain. fal image and video remain hidden until the real-key smoke test passes.',
    falKeyGetKey: 'Get a fal.ai API key →',
    falKeySavedUnverified: 'fal.ai key saved (not verified — validated on first generation)',
    wavespeedKeyTitle: 'WaveSpeed API Key (video)',
    wavespeedKeySet: 'Set',
    wavespeedKeyNotSet: 'Not set',
    wavespeedKeyInputLabel: 'WaveSpeed key',
    wavespeedKeyPlaceholder: 'Paste your WaveSpeed key',
    wavespeedKeyVerifySave: 'Verify & Save (WaveSpeed)',
    wavespeedKeyRemove: 'Remove WaveSpeed key',
    wavespeedKeyNote: 'Stored encrypted in your OS keychain. A valid-looking key may stay inactive until balance is topped up; WaveSpeed video remains hidden until the real-key smoke test passes.',
    wavespeedKeyGetKey: 'Get a WaveSpeed API key →',
    higgsfieldKeyTitle: 'Higgsfield API Credentials (video)',
    higgsfieldKeySet: 'Set',
    higgsfieldKeyNotSet: 'Not set',
    higgsfieldKeyInputLabel: 'Higgsfield key',
    higgsfieldKeyPlaceholder: 'Paste your Higgsfield key',
    higgsfieldSecretInputLabel: 'Higgsfield secret',
    higgsfieldSecretPlaceholder: 'Paste your Higgsfield secret',
    higgsfieldKeyVerifySave: 'Verify & Save (Higgsfield)',
    higgsfieldKeyRemove: 'Remove Higgsfield credentials',
    higgsfieldKeyNote: 'The key and secret are combined as key:secret and stored encrypted in your OS keychain. Higgsfield video remains hidden until the real-key smoke test passes.',
    higgsfieldKeyGetKey: 'Get Higgsfield API credentials →',
    ...
    videoProvider_wavespeed: 'WaveSpeed',
    videoProvider_higgsfield: 'Higgsfield',
    ...
    modelImgGptImage: 'OpenAI · character consistency · 16:9 approximated to 3:2',
    modelImgFalFlux: 'fal.ai FLUX Pro 1.1 · provisional until real-key verification',
    modelVidLite: 'Cheapest — drafts / high volume',
    modelVidFast: 'Cheap · fast',
    modelVidQuality: 'Top quality · cinematic',
    modelVidGrok: 'xAI Grok Imagine · provisional until real-key verification',
    modelVidFalKling: 'fal.ai Kling 2.1 Standard · provisional until real-key verification',
    modelVidWaveSpeedWan: 'WaveSpeed WAN 2.1 T2V 480p · provisional until real-key verification',
    modelVidHiggsfieldDopTurbo: 'Higgsfield DoP Turbo · provisional until real-key verification',
    modelDocsLink: 'Docs ↗',
