...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  settings: {
    ...
    // Shared API key field + TTS-specific notes
    ...
    // Provider-specific generation notes
    ...
    // Shared API key state and actions
    apiKeySet: '✓ Key saved',
    ...
    apiKeySavedUnverified: 'API key saved (not verified — validated on first use)',
    ...
    apiKeySecurityNote: 'API keys are encrypted with your OS keychain and stored only on this device. Each key is sent only to its own provider, never to us.',
    // Onboarding guide
  ...
  toast: {
    ...
    sessionTargetUnsupported: 'Generation is unavailable for the selected session target.',
    chatgptReferencesUnsupported: 'ChatGPT reference-image upload has not been measured, so this request was not submitted.',
    chatgptVideoUsesApi: 'Video is routed to the API provider on the ChatGPT target and cannot start from this session view.',
    chatgptUnmeasuredOptionsIgnored: 'The ChatGPT target cannot control aspect ratio or seed — images are generated square, without seed reproducibility, regardless of the project settings.',
