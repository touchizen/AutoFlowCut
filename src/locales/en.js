...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  audioTimeline: {
    ...
    kenBurnsDesc: 'Preview zoom/pan animation in the monitor. Shown only while Ken Burns is enabled in Export settings (export itself is controlled there)',
  },
  ...
  upscayl: {
    ...
    blockedByUpscayl: 'An upscale is running — try again after it finishes',
    checking: 'Checking for Upscayl...',
    notInstalled: 'Upscayl is not installed',
    noModels: 'Upscayl models were not found',
    installHintMac: 'Install it with `brew install --cask upscayl`, or download it from upscayl.org.',
    installHintWindows: 'Download and install Upscayl from upscayl.org.',
    installHintLinux: 'Install the .deb package, or locate a manually extracted AppImage binary.',
    openWebsite: 'Open upscayl.org',
    locate: 'Locate',
    recheck: 'Re-check',
    model: 'Model',
    scale: 'Scale',
    targetOne: '{count} target',
    targetMany: '{count} targets',
    alreadyUpscaled: '{count} already upscaled',
    skippedNoFile: '{count} skipped (no file)',
    start: 'Start',
    cancel: 'Cancel',
  ...
  exportModal: {
    ...
    renderPackage: 'Local MP4 Render',
    renderPackageDesc: 'Render a finished MP4 locally without using export credits',
    renderMode: 'Render quality',
    renderModePreview: 'Preview · 720p',
    renderModeFinal: 'Final · Full resolution',
    renderBurnSubtitle: 'Burn subtitles into video',
    renderBurnSubtitleHint: 'Embed subtitles directly into the rendered MP4.',
    renderProgress: 'Rendering MP4…',
    renderElapsed: 'elapsed {time}',
    renderCancel: 'Cancel render',
    renderCancelConfirm: 'Cancel the render in progress? Work rendered so far will be discarded.',
  ...
  toast: {
    ...
    renderComplete: 'MP4 render complete!',
    renderCancelled: 'MP4 render cancelled.',
