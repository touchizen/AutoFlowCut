...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  toast: {
    ...
    authErrorStop: 'Auth error. Stopping. Check your API key and try again.',
    ...
    flowLoginRequired: 'Google API key required. Add it in Settings.',
    flowLoginExpiredTitle: 'API Key Required',
    flowLoginExpiredMessage: 'Add or update your Google API key in Settings, then try again.',
