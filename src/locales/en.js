...
Ocean waves crashing against a lighthouse during a dramatic storm`,
  ...
  import: {
    ...
    storyboardHeaderDuplicate: 'Multiple CSV headers bind to the same storyboard field.',
    storyboardHeaderUnknown: 'The CSV contains an unsupported or corrupted header.',
    storyboardSceneInvalid: 'The scene value is blank or is not a JavaScript safe integer.',
    storyboardSceneOrderInvalid: 'Scene ordinals decrease in row order.',
    storyboardPromptAmbiguous: 'A slot contains more than one distinct prompt.',
    storyboardFieldAmbiguous: 'A slot contains conflicting values for a collapsed scene field.',
    storyboardPromptMissing: 'A visual-only slot requires an English prompt.',
    storyboardSpeakerMissing: 'A row with subtitles is missing its speaker.',
    storyboardSpeakerUnknown: 'The speaker is not in the roster or is a reserved narrator alias.',
    storyboardSpeakerAmbiguous: 'The speaker matches more than one roster card.',
    storyboardTimeInvalid: 'A time value is missing or is not a valid ordered plain-decimal time.',
    storyboardDurationMissing: 'A visual-only slot requires a prompt and a valid duration.',
