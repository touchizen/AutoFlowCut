...
- ~~**드롭한 mp3의 영속성**~~ → **별도 phase에서 해결됨**: [2026-05-27-audio-drop-persistence.md](./2026-05-27-audio-drop-persistence.md)
  옵션 B (폴더 정규화) 채택. 드롭 시 mp3가 `<audioFolderPath>/media[/sfx]/`로 복사되어 다음 폴더 import가 자동 픽업.
