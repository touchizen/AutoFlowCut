...
```
Generate AI images & videos with Google Flow, then export complete CapCut projects in one click.
```
...
AutoFlowCut is completely free and open source.
...
```
Google Flow AI로 이미지/비디오를 생성하고 CapCut 프로젝트로 원클릭 내보내기하는 데스크톱 앱
```
