...
const screenshots = [
  ...
  { file: '스크린샷 2026-07-11 190915.png', caption: '제목만 넣으면 훅과 기승전결을 갖춘 대본을 AI가 완성' },
  { file: '스크린샷 2026-06-06 200217.png', caption: '이미지 100장도 2~5분 안에 빠르게 대량 생성' },
  { file: '스크린샷 2026-07-01 191528.png', caption: '@를 입력해 캐릭터·장면·스타일 레퍼런스를 손쉽게 삽입' },
  { file: '스크린샷 2026-07-01 191623.png', caption: '@멘션으로 장면마다 같은 캐릭터를 일관되게 유지' },
  { file: '스크린샷 2026-07-01 191643.png', caption: '생성한 영상 장면을 앱에서 바로 미리보기' },
  { file: '스크린샷 2026-06-06 200318.png', caption: '대본, CSV, 레퍼런스, 자막, 오디오 패키지를 손쉽게 가져오기' },
  { file: '스크린샷 2026-07-01 193615.png', caption: '한 프로젝트를 CapCut · Premiere · Vrew로 자유롭게 내보내기' },
  { file: '스크린샷 2026-06-06 201227.png', caption: '내보낸 프로젝트를 CapCut에서 열어 바로 최종 편집' },
  { file: '스크린샷 2026-07-01 201020.png', caption: '내보내면 Premiere에서 자동으로 오픈' },
];
