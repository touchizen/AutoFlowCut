            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  ...
                  styleId: { type: 'string', description: '스타일 ID. 형식: "ref:<id>" (커스텀 레퍼런스), "preset:<id>" (프리셋), plain id (예: "korean-ani" — 자동으로 "preset:"으로 wrap), 또는 "none" (스타일 강제 미적용 — fallback도 안 함). 생략 시 우선순위: 사용 가능한 첫 style 카드 → 미적용. UI 선택값은 사용하지 않음 (레퍼런스 생성에는 씬 매칭 개념 없음).', example: 'ref:1773499846144' },
                },
              },
            },
          },
