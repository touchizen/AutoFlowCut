...
export function buildShoppingPlanPrompt(sourceFacts, assets, constraints) {
  ...
  return [
    ...
    '- Fact meanings: reviewCount is product-review count; monthlyPurchaseCount is the page-stated minimum buyers in one month; listPriceKrw is list price; brand and category are exact page labels.',
    '- reviewCount and monthlyPurchaseCount must use only their fieldFormats. Never put social-count values into generic template placeholders or emit them as bare numbers.',
