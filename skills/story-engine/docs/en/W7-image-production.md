...
**Review (substep 7-2b)** — subagent self-review → list issues → revise. Max 5 rounds. 0 issues → proceed immediately to the 7-3 user gate. 5 rounds exceeded → escalate to user.
